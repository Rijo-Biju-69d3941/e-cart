    ...
    <div style={{ marginTop:"70px"}}>
      ...
      <Card.Body>
       ...
       <div className="d-flex justify-content-between">
        <Button className='btn btn-light' onClick={()=>handleWishlist(product)}><i class="fa-solid fa-heart " style={{color: 'RGB(169,145,212)'}}></i></Button>
        <Button className='btn btn-light' onClick={()=>handleCart(product)}><i class="fa-solid fa-cart-shopping "style={{color: '#72BF78'}}></i></Button>
        </div>
      </Card.Body>
    </Card>
        </Col>)):
